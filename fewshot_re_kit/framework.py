...
class FewShotREModel(nn.Module):
    def __init__(self, sentence_encoder, entity_encoder):
        '''
...
class FewShotREFramework:
    ...
    def train(self,
        ...
        test_acc = self.eval(model, B, N_for_eval, K, Q, test_iter,
                             ckpt=os.path.join(ckpt_dir, model_name + '.pth.tar'), noise_rate=noise_rate)
    ...
    def predict(self, support, query, N, K, Q):
        return self.model(support, query, N, K, Q)
